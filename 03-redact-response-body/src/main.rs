use wstd::http::{Body, Error, Request, Response, Client};
...
async fn main(_req: Request<Body>) -> Result<Response<Body>, Error> {
    ...
    let mut people_resp = Client::new().send(Request::new("http://10.1.1.4:8001/people.json")).await?;
    ...
    struct Person { firstname: String, lastname: String, city: String, ssn: String }
